...
def parse_star(rx, nfa, p, curr_state):
    ...
    logging.debug("Out star:" + str(p))

    return nfa, p, curr_state

def parse_plus(rx, nfa, p, curr_state):
    logging.debug("In plus:" + str(p))

    

    logging.debug("Out plus:" + str(p))
